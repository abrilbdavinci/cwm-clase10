...
<template>
    ...
    >
        ...
        <div class="mb-3">
            <label for="display_name" class="block mb-1">Usuario</label>
            <input
                type="text"
                id="display_name"
                class="w-full p-2 border border-gray-400 rounded"
        ...
        <button type="submit" class="transition px-4 py-2 rounded bg-blue-600 hover:bg-blue-500 focus:bg-blue-500 text-white">Actualizar mis datos</button>
    </form>
</template>